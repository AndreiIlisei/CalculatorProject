  ...
  return (
    <Container>
      <Grid>
        ...
        <Button label="=" position={[3, 4]} onClick={handleOperator(OperatorType.Equals)} 
        height={2} />
        {mapButton.map((element) => (
          <Button buttonType={ButtonType.Number} key={uuidv4()} {...element}  />
        ))}
      </Grid>
    </Container>
  );
